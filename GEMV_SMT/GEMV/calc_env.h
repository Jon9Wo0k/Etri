...
typedef struct VCalcParamsTg
{
   ...
   vectortype_t *C;
   matrixtype_t *micro_A;
   vectortype_t *micro_B; // Buffer ITEMS_PER_CACHE_LINE * k_step
   vectortype_t alpha;
   unsigned k_size; // height of B and width of A
   unsigned n_size;
   unsigned m_size; // height of A and C
...
void update_params_gemv(VCalcParams *params,double L1_kt, unsigned core_length);
